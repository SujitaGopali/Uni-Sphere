...
void main() {
  ...
  testWidgets('should display core signup fields', (tester) async {
  ...
  testWidgets('should show error when required fields empty', (tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
  ...
  testWidgets('should show error snackbar when passwords do not match',
      (tester) async {
    await tester.pumpWidget(createWidgetUnderTest());
    ...
    await tester.enterText(textFields.at(3), 'password321');

    // Select college via dropdown
    await tester.tap(find.byType(DropdownButtonFormField<String>));
    await tester.pumpAndSettle();
    await tester.tap(find.text('Herald College Kathmandu (University of Wolverhampton)').last);
    await tester.pumpAndSettle();
  ...
  testWidgets('should navigate to login page when login link is clicked',
      (tester) async {
